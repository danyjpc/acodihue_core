package com.peopleapps.controller.associate.partner;
...
@Path("/associate/partner/addresses")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@Tag(name = "addresses by associate")
public class AdmAssociatePartnerAddressController {
    ...
    public Response getAll(
        ...
        List<AdmAddress> admAddressList = admAddressRepository.getAllPartnerAddressesByAssociate(
