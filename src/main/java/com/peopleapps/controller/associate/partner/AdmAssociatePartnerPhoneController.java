...
@Path("/associate/partner/phones")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@Tag(name = "addresses by associate")
public class AdmAssociatePartnerPhoneController {
    ...
    public Response getAll(
        ...
        List<AdmPhone> admPhoneList = admPhoneRepository.getAllPartnerPhonesByAssociate(
