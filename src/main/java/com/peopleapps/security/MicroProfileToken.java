...
public class MicroProfileToken {
    private String iss;
    private String aud;
    private String jti;
    private Long exp;
    ...
    public String toJSONString() {
        ...
        jsonObject.appendField("person_key", personKey);
        jsonObject.appendField("email", email);
        jsonObject.appendField("role_id", roleId);
        jsonObject.appendField("role", roleName);
